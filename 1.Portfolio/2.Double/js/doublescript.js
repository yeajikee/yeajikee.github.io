...
// //메뉴고정질문
// var MenuNav = document.getElementById('wrapper');

// // console.log(MenuNav);
// // var scrollfigure = MenuNav.scrollHeight;
// // var scrolltop = scrollfigure.scrollTop();
// MenuNav.addEventListener('scroll', MenuFixed());
// function MenuFixed(){
//     console.log(scrollTop);
//     //     if( scrollfigure  > 0  )
//     //     {
//     //         // console.log( scrollfigure);
